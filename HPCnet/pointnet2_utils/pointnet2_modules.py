...
class _PointnetSAModuleBase(nn.Module):
    ...
    def forward(self, xyz: torch.Tensor, features: torch.Tensor = None, new_xyz=None) -> (torch.Tensor, torch.Tensor):
        ...
        for i in range(len(self.groupers)):
            ...
            if self.pool_method == 'max_pool':  # 针对分类时才需要把npoint个特征进行maxpooling
...
class HPC_SAModuleMSG(_PointnetSAModuleBase):
    ...
    def __init__(self, *, npoint: int, radii: List[float], nsamples: List[int], mlps: List[List[int]], bn: bool = True,
                 use_xyz: bool = True, pool_method=None, instance_norm=False):
        """
        :param npoint: int
...
class PointnetSAModule(PointnetSAModuleMSG):
    ...
    def __init__(self, *, mlp: List[int], npoint: int = None, radius: float = None, nsample: int = None,
                 bn: bool = True, use_xyz: bool = True, pool_method=None, instance_norm=False):
        """
